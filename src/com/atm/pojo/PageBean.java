...
//get、set方法。
	...
	public String toString() {
		return "PageBean [pageNum=" + pageNum + ", pageSize=" + pageSize + ", totalRecord=" + totalRecord
				...
				+ ", end=" + end + ", getPageNum()=" + getPageNum() + ", getPageSize()=" + getPageSize()
				+ ", getTotalRecord()=" + getTotalRecord() + ", getTotalPage()=" + getTotalPage() + ", getStartIndex()="
				+ getStartIndex() + ", getList()=" + getList() + ", getStart()=" + getStart() + ", getEnd()=" + getEnd()
