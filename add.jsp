     ...
     <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">新增用户</a>
                </li>
            ...
            <div align="center"><form action="../insert" method="post">
 <font size="6" face="黑体" ><strong>请输入以下信息完成注册：</strong>
  ...
  <tr>
  <div id="font-bg-color">
  	<td><font size="4">用户卡号：</font></td>
  	<td>  <font size="3" face="黑体" ><input type="text" name="icno" class="form-control"></font></td>
  </div>
  </tr>
  ...
  <td colspan="2" align="center">
	<font size="2"><input type="submit" value="提交"></font>
	<font size="2"><input type="reset" value="重置"></font>
 </td>
  </tr>
